...
<head>
  ...
  <link href="{{ asset('public/')}}/public/assets/vendor/quill/quill.snow.css" rel="stylesheet">
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a  href="{{route('forms')}}" class="nav-link collapsed">
          <i class="bi bi-journal-text"></i><span>Forms</span>
        </a>
      
      </li><!-- End Forms Nav -->
      <li class="nav-item">
        <a  href="{{route('display')}}" class="nav-link collapsed">
          <i class="bi bi-journal-text"></i><span>view list</span>
        </a>
